...
class UsersDirectoryArtistaHome extends StatefulWidget {
  const UsersDirectoryArtistaHome({super.key});

  @override
  State<UsersDirectoryArtistaHome> createState() => _UsersDirectoryArtistaHomeState();
}

class _UsersDirectoryArtistaHomeState extends State<UsersDirectoryArtistaHome> {
